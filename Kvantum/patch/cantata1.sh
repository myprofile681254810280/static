target=~/.config/Kvantum/cantata1 
kvconfig=~/.config/Kvantum/cantata1/cantata1.kvconfig 
...
#删除尾部的</svg>
sed '$d' /usr/share/Kvantum/KvArc/KvArc.svg > $target/cantata1.svg
cat ~/.config/Kvantum/patch/cantata1.svg >> $target/cantata1.svg

cd ..
python ~/.config/Kvantum/patch/roundmenu.py cantata1 "opacity:0.3;fill:#ffffff;"
